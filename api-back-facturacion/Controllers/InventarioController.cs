...
namespace api_back_facturacion.Controllers
{
    ...
    public class InventarioController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Tabla_Inventario>>> GetInventario()
        {
            try
            {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Tabla_Inventario>> GetInventario(Int64 id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<Tabla_Inventario>> PostInventario([FromBody] InventarioDto value)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Tabla_Inventario>> PutInventario(Int64 id, [FromBody] InventarioDto value)
        {
            try
            {
                var obj = await _inventarioRepositorio.CreateUpdate(value);
