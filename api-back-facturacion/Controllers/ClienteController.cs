...
namespace api_back_facturacion.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Tabla_Cliente>>> GetCliente()
        {
            try
            {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Tabla_Cliente>> GetCliente(Int64 id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Tabla_Cliente>> PostCliente([FromBody] ClienteDto value)
        {
            try
            {
