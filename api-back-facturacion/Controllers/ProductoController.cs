...
namespace api_back_reserva.Controllers
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Tabla_Producto>>> GetProducto()
        {
            try
            {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Tabla_Producto>> GetProductoById(Int64 id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<Tabla_Producto>> PostProducto([FromBody] ProductoDto value)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Tabla_Producto>> PutProducto(int id, [FromBody] ProductoDto value)
        {
            try
            {
                var obj = await _productoRepositorio.CreateUpdate(value);
