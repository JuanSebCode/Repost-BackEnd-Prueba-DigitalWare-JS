...
namespace api_back_facturacion.Controllers
{
    ...
    public class FacturacionController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Tabla_Facturacion>>> GetFacturacion()
        {
            try
            {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Tabla_Facturacion>> GetFacturacionById(Int64 id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Tabla_Facturacion>> PostFacturacion([FromBody] FacturacionDto value)
        {
            try
            {
